...
public class ApplicationPageStructural {
    ...
    public ApplicationPageStructural(WebDriver driver) {
        this.driver = driver;
    ...
    public int getCountOfTodo(StructuralEnums.ItemsInState state) {
        return getTodoItems(state).size();
    }

    public String getToDoText(int itemIndex) {
        List<WebElement> items = getTodoItems(StructuralEnums.ItemsInState.VISIBLE);
        return items.get(itemIndex).getText();
    }

    public List<WebElement> getTodoItems(StructuralEnums.ItemsInState state) {
    ...
    public void deleteTodoItem(int todoIndex) {
        ...
        inViewOnThePage(driver, todoListItem);
    ...
    public void clickOnFilter(StructuralEnums.Filter filter) {
